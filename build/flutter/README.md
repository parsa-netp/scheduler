...
* `scheduler` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `scheduler` - executable or bundle name on disk.
* `scheduler` - display name shown in window titles and about app dialogs.
